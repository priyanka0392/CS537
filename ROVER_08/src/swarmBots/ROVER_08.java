...
public class ROVER_08 {
	...
	private void run() throws IOException, InterruptedException {
		...
		while (true) {
			...
			System.out.println("ROVER_08 currentLoc at start: " + currentLoc);
			...
			//System.out.println("ROVER_08 equipment list results drive " + equipment.get(0));
			System.out.println("ROVER_08 equipment list results " + equipment + "\n");
			
	

			// ***** do a SCAN *****
			//System.out.println("ROVER_08 sending SCAN request");
			this.doScan();
			...
			if (blocked) {
				...
				if (goingEast) {
					...
					if (scanMapTiles[centerIndex][centerIndex -1].getHasRover() 
						...
						// request to server to move
						out.println("MOVE W");
						System.out.println("ROVER_08 request move W");
					}
			...
			System.out.println("ROVER_08 currentLoc after recheck: " + currentLoc);
			System.out.println("ROVER_08 previousLoc: " + previousLoc);
